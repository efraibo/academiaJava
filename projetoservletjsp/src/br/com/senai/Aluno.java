...
public class Aluno {
	...
	public Aluno(String nome, String matricula, String logradouro, String cep,
	...
	public Aluno(int id, String nome, String matricula, String logradouro,
			String cep, String complemento, String dataNascimento) {
		super();
		this.id = id;
		this.nome = nome;
		this.matricula = matricula;
